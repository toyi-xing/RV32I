...
| 外设 | Base | 大小 | 当前状态 |
|------|-----:|----:|----------|
| GPIO0 | `0x0008_0000` | 256 B | 已实现 OUT/IN/OE |
| TIMER0 | `0x0008_1000` | 256 B | 地址预留，访问 fault |
| UART0 | `0x0008_2000` | 256 B | 已实现 TXDATA/STATUS/CTRL |
| ACCEL0 | `0x0008_8000` | 4 KiB | 地址预留，访问 fault |
