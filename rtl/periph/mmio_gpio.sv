...
//   - access_fault_o 表示地址已命中本外设窗口，但 offset 未定义。真正未映射地址由 data_subsystem 汇总判断。
//
// 功能：
...
module mmio_gpio #(
    ...
    input  logic                      valid_i,         // 外层 bus adapter 完成一次 GPIO 访问；地址已命中 GPIO 窗口。
    ...
    wire [11:0]               offset      = {full_offset[11:2], 2'b00};
