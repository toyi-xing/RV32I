//------------------------------------------------------------------------------
// 文件      : uvm/v6_0/simple_bus/tb/seq/simple_bus_transfer.svh
...
class simple_bus_transfer extends uvm_sequence_item;
    ...
    function string transfer2string(string object_kind = "transfer");
    return $sformatf({observed_item.item2string(object_kind)," accept_cycle=%0d",
