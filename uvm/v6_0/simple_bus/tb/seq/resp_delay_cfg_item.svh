//------------------------------------------------------------------------------
// 文件      : uvm/v6_0/simple_bus/tb/seq/resp_delay_cfg_item.svh
...
class resp_delay_cfg_item extends uvm_sequence_item;

    rand soc_pkg::target_e  target;
    rand int                delay_cycles;

    `uvm_object_utils_begin(resp_delay_cfg_item)
    ...
    function new(string name = "resp_delay_cfg_item");
        super.new(name);
